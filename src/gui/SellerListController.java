...
public class SellerListController implements Initializable, DataChangeListener {
	...
	private void initializeNodes() {
		...
		tableColumnDepartment.setCellValueFactory(new Callback<CellDataFeatures<Seller, String>, ObservableValue<String>>() {
		     public ObservableValue<String> call(CellDataFeatures<Seller, String> p) {
		         return new ReadOnlyObjectWrapper<String>(p.getValue().getDepartment().getName());
		     }
		  });
